...
import { AIServiceError, type ModelConfig, type ProviderType } from './model-config';
import { generateWithSmartFallback, getFriendlyErrorMessage } from './smart-fallback';

export interface RouterRequest extends Omit<GenerateRequest, 'model'> {
  preferredModelId?: string;
  category?: 'general' | 'coding' | 'math' | 'conversation' | 'multimodal';
}

export interface RouterResponse extends GenerateResponse {
